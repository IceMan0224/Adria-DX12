...
namespace adria
{
	...
	namespace
	{
		...
		constexpr GfxShaderStage GetShaderStage(ShaderID shader)
		{
			...
			case CS_ReSTIR_GI_InitialSampling:
			case CS_ReSTIR_GI_TemporalResampling:
			case CS_ReSTIR_GI_SpatialResampling:
			case CS_ReSTIR_GI_Output:
		...
		constexpr std::string GetShaderSource(ShaderID shader)
		{
			...
			case CS_ReSTIR_GI_InitialSampling:
				return "ReSTIR/GI/InitialSampling.hlsl";
			case CS_ReSTIR_GI_TemporalResampling:
				return "ReSTIR/GI/TemporalResampling.hlsl";
			case CS_ReSTIR_GI_SpatialResampling:
				return "ReSTIR/GI/SpatialResampling.hlsl";
			case CS_ReSTIR_GI_Output:
				return "ReSTIR/GI/Output.hlsl";
			case CS_RendererDebugView:
		...
		constexpr std::string GetEntryPoint(ShaderID shader)
		{
			...
			case CS_RayTracedReflections:
				return "RayTracedReflectionsCS";
			case CS_RayTracedAmbientOcclusion:
				return "RayTracedAmbientOcclusionCS";
			case CS_DDGIRayTrace:
